...
<body>
	...
	<div>
		<form action="Join.do" method="post" name="f"
			...
			<table id="joinInfo">
				<tr id="info_content">
					<td colspan="2" id="joinMain">회원가입</td>
				</tr>
				<tr id="info_content">
					<td id="info_text">아이디</td>
					<td><input style='width: 75%; float: left;' type="text"
						name="id" required><input
						style="float: right; height: 44px" type="button" value="중복체크"
						onclick="chkID()"><input type="hidden" value="idUncheck"
						name="idCheck"></td>
				</tr>
				<tr id="info_content">
					<td id="info_text">비밀번호</td>
				...
				<tr id="info_content">
					<td id="info_text">생년월일</td>
					<td><select style="width: 30%; float: left;" name="year"
						disabled="disabled">
					...
					</select><span class="birth">년</span> <select
						style="width: 30%; float: left;" name="month" disabled="disabled">
							<option value="">선택</option>
							<c:forEach var="i" begin="1" end="12" step="1">
								<option value="${i }">${i }</option>
							</c:forEach>
					</select><span class="birth">월</span> <select
						style="width: 30%; float: left;" name="day" disabled="disabled">
							<option value="">선택</option>
							<c:forEach var="i" begin="1" end="31" step="1">
								<option value="${i }">${i }</option>
							</c:forEach>
					</select><span class="birth">일</span></td>
					<input type="hidden" name="birth" value="">
				</tr>
				<tr id="info_content">
					<td id="info_text">성별</td>
					<td><input class="sex" type="radio" name="gender" value="male">남성
						<input class="sex" type="radio" name="gender" value="female">여성</td>
				</tr>
				<tr id="info_content">
